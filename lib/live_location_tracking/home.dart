...
import 'package:flutter_map_application/location_service.dart';
import 'package:flutter_map_application/models/place_model.dart';
...
void setMyCameraPosition(LocationData locationData) {
  if(isFirst){ 
    ...
    CameraPosition cameraPosition=CameraPosition(target: LatLng(locationData.latitude!, locationData.longitude!),zoom: 5);
...
void setMyLocationMarker(LocationData locationData) {
    var myLocationMarker=Marker(markerId:MarkerId("zzzzzzz"),position: LatLng(locationData.latitude!, locationData.longitude!) );
